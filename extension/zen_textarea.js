/**
 * forked from Zen-Coding Textarea (http://code.google.com/p/zen-coding/)
 * base on Zen Coding textarea (http://code.google.com/p/zen-coding/downloads/detail?name=Zen.Coding-textarea.v0.7.zip)
 * MIT License (http://www.opensource.org/licenses/mit-license.php)
 */
function zen_cte(extensionOptions){
...
var zen_settings = {
	 ...
	 */
	'variables': {
		'lang': extensionOptions['lang'],
		'locale': extensionOptions['locale'],
		'charset': 'UTF-8',
		
		/** Inner element indentation */
		'indentation': extensionOptions['indent'],
